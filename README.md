...
Finally, I assigned the noteIndex to a note variable and returned both the initial frequency and note name as a template literal: 
'This is 440hz which is the note A',
